    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            <a class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                href="{{ route('admin.products.create') }}">Thêm Sản Phẩm</a>
        </div>
                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <td class="px-4 py-4">Image</td>
                                <td class="px-4 py-4">Quantity</td>
                                <td class="px-4 py-4">Category_id</td>
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @foreach ($data as $product)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td><img src="{{ asset('uploads/' . $product->image) }}" width="100px" height="150px"></td>                                    
                                    <td class="px-4 py-4">{{ $product->quantity }}</td>
                                    <td class="px-4 py-4">{{ $product->category_id }}</td>
                                    <td ><a
                                            class="flex items-center justify-between px-2 py-2  text-purple-600  "
                                            aria-label="Edit"
                                            href="{{ route('admin.products.edit', ['product' => $product->id]) }}"><svg
                                            ...
                                            <div >
                                                <button @click={show=true} type="button"
                                                    ...
                                                    data-target="#confirm_delete_{{ $product->id }}"><svg class="w-6 h-6"
                                            ...
                                            <div x-show="show" tabindex="0"
                                                ...
                                                <div @click.away="show = false"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="px-6 py-3 text-xl border-b font-bold text-gray-800 ">Xác nhận xóa thành
                                                            viên!
                                                        </div>
                                                        <div class="p-6 flex-grow text-gray-600">
